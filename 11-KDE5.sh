...
rsync -ah --delete $ROPT --log-file=/var/log/rsync-alien.log --timeout=300 bear.alienbase.nl::mirrors/alien-kde/current/latest/x86_64 $NP-work/

find $NP-work/ $FOPT | xargs rm -r

installpkg -root $NP $NP-work/deps/*.t?z
installpkg -root $NP $NP-work/kde/plasma/*.t?z
